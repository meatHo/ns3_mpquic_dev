...
QuicSocketBase::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::QuicSocketBase")
    ...
    .AddAttribute ("MaxStreamIdBidi",
                   ...
                   UintegerValue (10),                   // according to the QUIC RFC this value should default to 0, and be increased by the client/server
...
// --- 수정된 코드 시작 ---
  ...
  {
    NS_LOG_INFO ("CONNECTION AUTHENTICATED: Client address found in authenticated list or 0-RTT is allowed.");

    ...
    static TypeId tid =
        TypeId("ns3::UdpClient")
            ...
            .AddAttribute("slServerAddress",
                          ...
                          AddressValue(),
                          MakeAddressAccessor(&UdpClient::m_slServerAddress),
                          MakeAddressChecker())
            .AddAttribute("slServerPort",
                          "The destination port of the outbound packets",
                          UintegerValue(100),
                          MakeUintegerAccessor(&UdpClient::m_slServerPort),
                          MakeUintegerChecker<uint16_t>())
            .AddAttribute("uuServerAddress",
                          "The destination Address of the outbound packets",
                          AddressValue(),
                          MakeAddressAccessor(&UdpClient::m_uuServerAddress),
                          MakeAddressChecker())
            .AddAttribute("uuServerPort",
                          "The destination port of the outbound packets",
                          UintegerValue(100),
                          MakeUintegerAccessor(&UdpClient::m_uuServerPort),
                          MakeUintegerChecker<uint16_t>())
            .AddAttribute("recvPort",
                          "The destination port of the outbound packets",
                          UintegerValue(100),
                          MakeUintegerAccessor(&UdpClient::m_recvPort),
                          MakeUintegerChecker<uint16_t>())
            .AddAttribute("Tos",
...
UdpClient::StartApplication()
{
    ...
    m_uuSocket->SetRecvCallback(MakeCallback(&UdpClient::HandleRecv, this));
    m_slSocket->SetRecvCallback(MakeCallback(&UdpClient::HandleRecv, this));
...
void
UdpClient::HandleRecv(Ptr<Socket> socket)
{
...
void
UdpClient::SelectInterface(Ptr<Socket> socket)
{
...
void
UdpClient::setInterface(Ptr<NetDevice> uu, Ptr<NetDevice> sl)
{
    m_devSl = sl;
    m_devUu = uu;
}

...
int main(void)
{
    ...
    rsuStaticRouting->AddNetworkRouteTo(Ipv4Address("10.1.3.2"),
                                       ...
                                       routerRsuIp,
                                       /* 라우터의 RSU 방향 인터페이스 */rsuRouterItf);
    ...
    routerStaticRouting->AddNetworkRouteTo(Ipv4Address("10.1.3.2"),
                                       Ipv4Mask("255.255.255.255"),
                                       serverRouterIp,
                                       /* 라우터의 RSU 방향 인터페이스 */routerServerItf);
    ...
    stackHelper.PrintRoutingTable(ue);
    ...
    tft = Create<LteSlTft>(LteSlTft::Direction::BIDIRECTIONAL, rsuSlIp, slInfo);
